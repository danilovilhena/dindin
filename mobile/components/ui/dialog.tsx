...
function DialogOverlayNative({
  ...
  return (
    <DialogPrimitive.Overlay style={StyleSheet.absoluteFill} className={cn("flex bg-black/80 justify-center items-center p-2", className)} {...props}>
...
function DialogTitle({
  ...
  return <DialogPrimitive.Title className={cn("text-lg native:text-xl text-foreground font-semibold leading-none tracking-tight", className)} {...props} />;
}
...
function DialogDescription({
  ...
  return <DialogPrimitive.Description className={cn("text-sm native:text-base text-muted-foreground", className)} {...props} />;
}
